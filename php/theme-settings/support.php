...
function add_size_guide_next_to_sizes() {
    ?>
    <button id="sizeGuideBtn" class="flex items-center gap-2 text-base font-medium text-black font-secondary cursor-pointer mb-11 hover:bg-[rgba(0,0,0,0.05)] transition-all duration-300 p-2 rounded underline">
