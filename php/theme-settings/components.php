...
function hy_shared_btn( $title, $url, $text = 'Check out this amazing content!' ) {
    if ( ! $title ) {
        return '';
    }
    if ( ! $url ) {
...
function hy_share_modal_container() {
    ?>
    <div id="hy-share-modal" class="fixed inset-0 bg-black/75 flex items-center justify-center z-50 p-4 hidden">
