...
<section class="text-center py-[108px] px-4">
    <div class="container mx-auto">
        <?php if( $label ) : ?>
            <p class="uppercase text-base font-secondary text-[#27221E] tracking-widest"><?= $label; ?></p>
        <?php endif; ?>
        ...
        <?php if( $collection ) :
            ...
            if( $collect ) :
                ...
                <a href="<?= esc_url($term_link); ?>" class="relative w-full sm:w-[48%] md:w-[30%] lg:w-[315px] h-auto lg:h-[472px] group overflow-hidden block">
