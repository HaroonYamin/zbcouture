...
<section class="container mx-auto px-4 my-[140px]">
    <div class="flex flex-col lg:flex-row items-start mb-16">
        ...
        <div class="max-w-[427px] lg:ml-[350px] mb-6 lg:mt-0">
            ...
            <?php if( $link ) : ?>
                <a href="<?= $link; ?>" 
                    class="inline-block border border-black px-[22px] py-[12px] rounded-[12px] font-secondary text-base font-medium hover:bg-black hover:text-white transition-all mt-4">
                    Explore Collection
                </a>
            <?php endif; ?>
        </div>
