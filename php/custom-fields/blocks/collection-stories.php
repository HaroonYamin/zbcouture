...
<section class="sm:py-32 py-16">
    <div class="container mx-auto sm:px-4 px-0">
        ...
        <div class="text-center">
            <?php if( $label ) : ?>
                <h5 class="text-base font-normal uppercase tracking-widest text-[#27221E] mb-[25px] text-center"><?= $label; ?></h5>
            <?php endif; ?>
            ...
            <?php if( $button ) : ?>
                <a href="<?= $button['url']; ?>" 
                    class="inline-block mt-[25px] font-medium text-[16px] bg-white border border-[#27221E] rounded-[12px] text-[#27221E] px-[36px] py-[12px] hover:bg-[#27221E] hover:text-white transition"
        ...
        <div class="overflow-x-auto xl:overflow-visible scroll-smooth touch-auto sm:touch-none">
            ...
            <div class="m">
                <button id="scroll-arrow-left" class="absolute mt-5 right-16 sm:hidden z-4">
                ...
                <button id="scroll-arrow-right" class="absolute mt-5 right-4 sm:hidden z-4" >
                    <svg width="28px" height="28px" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
