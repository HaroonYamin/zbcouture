  ...
  <div class="container mx-auto px-4">
    ...
    <!-- Heading -->
     <div class="text-center">
       <p class="text-base font-normal uppercase tracking-widest text-[#27221E] mb-[25px] text-center">OUR COLLECTION</p>
        <h2 class="text-[40px] font-normal font-primary leading-tight text-[#27221E] max-w-[530px] mx-auto text-center">
          <span class="not-italic">A</span> <span class="italic">Gallery of Hand-Painted</span> <span class="not-italic">Dreams</span>
        </h2>
        <a href="#" class="inline-block mt-[25px] font-medium text-[16px] bg-white border border-[#27221E] rounded-[12px] text-[#27221E] px-[36px] py-[12px] hover:bg-[#27221E] hover:text-white transition">
          Explore Our Shop
        </a>
     </div>
    <!-- Responsive wrapper -->
    <div class="flex xl:grid xl:grid-cols-3 sm:gap-6 gap-4 xl:justify-items-center overflow-x-auto xl:overflow-visible scroll-smooth whitespace-nowrap mt-[50px]">
