  ...
  <div class="container mx-auto px-4 flex flex-col lg:flex-row items-center lg:justify-between gap-12">
    ...
    <div class="w-full xl:basis-2/6 text-left">
      ...
      <div id="readMoreContainer">
        <?php if( $first ) : ?>
          <div class="text-[#27221E] font-light leading-[1.3] font-secondary mt-[18px] max-w-[517px]">
            <?= $ui->paragraph( $first ); ?>
          </div>
        <?php endif; ?>

        <?php if( $second ) : ?>
          <div id="secondPara" class="text-[#27221E] font-light leading-[1.3] font-secondary max-w-[517px] truncate-4">
            <?= $ui->paragraph( $second ); ?>
          </div>
        <?php endif; ?>
